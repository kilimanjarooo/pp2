...
bg = pg.image.load("C:\\Users\\Kilimanjaro\\Desktop\\pp2\\gitTest\\pp2\\lab10\\img\\background.jpg")
bg = pg.transform.scale(bg, (w, h))
gameover = pg.image.load("C:\\Users\\Kilimanjaro\\Desktop\\pp2\\gitTest\\pp2\\lab10\\img\\game_over.jpg")
...
class Food:
    ...
    def draw2(self):
        ...
        self.y = randrange(0, h, step)
        self.r = randint(1, 3)
        self.image = pg.image.load(f'C:\\Users\\Kilimanjaro\\Desktop\\pp2\\gitTest\\pp2\\lab10\\img\\food{self.r}.png')
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pg.image.load("C:\\Users\\Kilimanjaro\\Desktop\\pp2\\gitTest\\pp2\\lab10\\img\\wall.png")
...
s = Snake()
f = Food(pg.image.load(f'C:\\Users\\Kilimanjaro\\Desktop\\pp2\\gitTest\\pp2\\lab10\\img\\food{randint(1,3)}.png'))
disappear(5000)
